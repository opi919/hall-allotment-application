        ...
        @else
            <form method="POST" action="{{ route('student.form.submit') }}"
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <select name="relatives_in_rajshahi"
                            ...
                            <option value="yes" {{ old('relatives_in_rajshahi') == 'yes' ? 'selected' : '' }}>Yes
                            </option>
                            <option value="no" {{ old('relatives_in_rajshahi') == 'no' ? 'selected' : '' }}>No
                            </option>
                        </select>
                    ...
                    <div>
                        ...
                        <select name="is_home_in_rajshahi"
                            class="w-full border border-gray-400 rounded-xl px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">Select</option>
                            <option value="yes" {{ old('is_home_in_rajshahi') == 'yes' ? 'selected' : '' }}>Yes
                            </option>
                ...
                <div class="grid md:grid-cols-1 gap-4">
                    <div>
                        ...
                        <select id="academic_system" name="academic_system"
                            ...
                            <option value="yearly" {{ old('academic_system') == 'yearly' ? 'selected' : '' }}>Yearly
                                System
                            </option>
                            <option value="semester" {{ old('academic_system') == 'semester' ? 'selected' : '' }}>Semester
                                System</option>
                        </select>
                        <p class="text-red-500 text-sm mt-1 hidden" id="academic-system-error">Select academic system
                            first
                        </p>
                ...
                <div id="last_highest_gpa" class="grid md:grid-cols-2 gap-4 hidden">
                    <div class="">
                        <label class="font-semibold last_gpa_label">Highest GPA/SGPA/YGPA/CGPA in the Applicant’s Latest
                            Result
                            Sheet</label> <br>
