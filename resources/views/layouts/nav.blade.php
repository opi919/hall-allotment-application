    <nav class="fixed top-0 left-0 right-0 z-50 bg-gray-700 text-white shadow-md" x-data="{ profileOpen: false }">
        ...
        <div class="w-full mx-auto px-4 sm:px-6 lg:px-12">
            <div class="flex justify-between items-center h-20">
                ...
                <!-- Logo -->
                <a href="{{ env('APP_URL') }}" class="flex items-center text-lg font-bold tracking-wide">    <div class="flex items-center justify-center w-12 h-12 bg-white rounded p-1">
                        <img src="{{ asset('logo.png') }}" class="" alt="Logo">
                    </div>
                    <div class="flex flex-col">
                        <span class="ml-2">University of Rajshahi</span>
                        <span class="ml-2 text-sm font-sm">Hall Allotment Application</span>
                    </div>
                </a>
